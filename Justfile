...
palmerston_north:
    ...
    @test -d models/PalmerstonNorthPliocene.zarr || {{ construct }} ${NZCVM_DATA_ROOT}/regional/PalmerstonNorth/PalmerstonNorth_outline_WGS84.geojson ${NZCVM_DATA_ROOT}/surface/NZ_DEM_HD.h5 ${NZCVM_DATA_ROOT}/regional/PalmerstonNorth/PalmerstonNorth_pliocenetop_WGS84_v25p8.h5 ${NZCVM_DATA_ROOT}/regional/PalmerstonNorth/PalmerstonNorth_basement_WGS84_v25p8.h5 models/PalmerstonNorthPliocene.zarr --rho 2.12 --vp 2.6 --vs 1.1  --smoothing {{ smoothing }} --coastline {{ coastline }}
